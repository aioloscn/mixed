...
public class AlgoFrame extends JFrame {
    ...
    private class AlgoCanvas extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            drawFractal(g2d, 0, canvasWidth / 3, canvasWidth, 0, 0);
            drawFractal(g2d, canvasWidth / 2, canvasHeight, canvasWidth, 120.0, 0);
            drawFractal(g2d, canvasWidth, canvasWidth / 3, canvasWidth, -120.0, 0);
        }
